...
| Pi compatibility/kernel | T-002 | src/agent/kernel.ts, src/agent/tools.ts |
...
| CLI/session UX | T-007 | src/cli.ts |
...
| Test evidence | T-016 | src/testing/evidence.ts |
| Git/review | T-017 | src/repository.ts, src/review.ts |
| Ledger/checkpoints | T-018 | src/context/ledger.ts, src/storage/checkpoint.ts |
| Compaction | T-019 | PiAgentKernel compact + checkpoint/ledger CLI coordination |
